...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case WINDOWS_MODE_TOGGLE:
      ...
      break;
    case WINDOWS_KEY_TOGGLE:
      if (record->event.pressed) {
        windows_key_enabled = !windows_key_enabled;
      }
      break;
    case COPYPASTA_HELI:
...
[0] = LAYOUT_60_ansi_split_bs_rshift( /* Base */
    ...
    TD(CAPS_SPECIAL),  KC_A,     KC_S,     KC_D,  KC_F,  KC_G,  KC_H,    KC_J,  KC_K,  KC_L,     KC_SCLN,  KC_QUOT,           KC_ENT, 
    KC_LSFT,            KC_Z,     KC_X,  KC_C,  KC_V,  KC_B,    KC_N,  KC_M,  KC_COMM,  KC_DOT,   KC_SLSH,  RSFT_T(KC_UP), RSFT_T(KC_UP),
    KC_LCTL,  LALT_SWITCH, LGUI_SWITCH,                         KC_SPC,                          KC_LGUI,  LT(1, KC_LEFT),  RALT_T(KC_DOWN), RCTL_T(KC_RGHT)),

[1] = LAYOUT_60_ansi_split_bs_rshift( /* FN */
    KC_GRV,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_DEL, KC_TRNS,
    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_UP,  RESET,    KC_TRNS,
    WINDOWS_KEY_TOGGLE, KC_VOLD,  KC_VOLU,  KC_MUTE,  KC_MPLY,  KC_NO,    KC_NO,    KC_NO,    KC_PGUP,  KC_HOME,  KC_LEFT,  KC_RGHT,            KC_NO,
    WINDOWS_MODE_TOGGLE, BACK_TAB, FORWARD_TAB, CLOSE_TAB, SEARCH,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_PGDN, KC_END, KC_DOWN, LT(2,KC_NO),  LT(2,KC_NO),
